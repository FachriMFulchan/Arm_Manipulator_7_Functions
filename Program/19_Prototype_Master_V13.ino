/* V12
  ...
  Data berurutan: J1, J2, J3, J4, yawJ5, rollJ6, GripCount, Fold
  ...
  /* ====== JOYSTICK MODE ======= */
    ...
    if (fold == 0) {
      ...
      if (timeAfter - timeBefore >= 700) {
        ...
        String out = "#" + String(kode1) + "#" + String(steppJ1) + "#" + String(steppJ2) + "#" + String(steppJ3) + "#" + String(steppJ4) + "#" + String(yawJ5) + "#" + String(rollJ6) + "#" + String(gripCount) + "#" + String(fold) + "#$";
        Serial.println (out);
        Serial3.print (out);
        timeBefore = millis();
      }
...
int determineRollValue (int joyVal, int roll) {
  ...
  if (joyVal >= 650) {
    if (currentMillis - previousMillisRoll >= 5) {
      ...
      // Reset setelah satu putaran positive
      //      if (roll == 360) {
      //        roll = 0;
      //      }
  ...
  // Pengurangan Cepat
    ...
    if (currentMillis - previousMillisRoll >= 5) {
      ...
      // Reset setelah satu putaran negative
      //      if (roll == -360) {
      //        roll = 0;
      //      }
      previousMillisRoll = currentMillis;
